...
const Banner = () => {
  return (
    ...
    className='flex flex-col md:flex-row md:items-start items-center justify-between px-8 min-md:pl-14 pt-10 bg-gradient-to-r from-[#0558FE] to-[#A9CFFF] max-w-7xl mx-3 md:mx-auto rounded-2xl overflow-hidden'>
