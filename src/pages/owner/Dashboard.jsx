  ...
  return (
    <div className="px-4 pt-10 md:px-10 flex-1">
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-8 max-w-3xl">
        {
          dashboardCards.map((card, index) => (
            <div key={index} className="flex gap-2 items-justify-between p-4 rounded-md border border-borderColor">
              <div>
      ...
      <div className="flex flex-wrap items-start gap-6 mb-8 w-full">
              ...
              <div key={index} className="mt-4 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="hidden md:flex items-center justify-center w-12 h-12 rounded-full bg-primary/10">
                    <img src={assets.listIconColored} alt="colored list icon" className="h-5 w-5" />
                  </div>
                  <div>
        ...
        {/* monthly booking */}
        <div className="p-4 mb:p-6 mb-6 border border-borderColor rounded-md w-full md:max-w-xs">
