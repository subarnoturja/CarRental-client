        ...
        <motion.div 
          ...
          key={index} className="grid grid-cols-1 md:grid-cols-4 gap-6 p-6 border border-borderColor rounded-lg mt-5 first:mt-12">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-gray-500">{booking.car.year}▫️{booking.car.category}▫️{booking.car.location}</p>
            </div>
            {/* Booking Info */}
            <div className="md:col-span-2">
              ...
              <div className="flex items-start gap-2 mt-3">
                <img src={assets.calendar_icon_colored} alt="colored calender icon" className="w-4 h-4 mt-1" />
                <div>
              ...
              {/* Location Section */}
              <div className="flex items-start gap-2 mt-3">
                <img src={assets.location_icon_colored} alt="colored location icon" className="w-4 h-4 mt-1" />
                <div>
