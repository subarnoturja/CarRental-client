    ...
    <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          className="lg:col-span-2">
            ...
            src={car.image} alt="car image" className="w-full h-auto md:max-h-100 object-cover rounded-xl mb-6 shadow-md" />
            <motion.div 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            ...
            className="space-y-6">
              <div>
                ...
                <p className="text-gray-500 text-lg">{car.category}▫️{car.year}</p>
              </div>
